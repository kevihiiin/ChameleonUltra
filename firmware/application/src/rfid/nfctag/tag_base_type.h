...
typedef enum {
    ...
    TAG_TYPE_INDALA = 310,
    TAG_TYPE_KERI = 320,
    TAG_TYPE_NEXWATCH = 330,
    TAG_TYPE_MOTOROLA = 370,
    TAG_TYPE_IDTECK = 380,
...
#define TAG_SPECIFIC_TYPE_LF_VALUES \
    TAG_TYPE_EM410X, TAG_TYPE_EM410X_ELECTRA, TAG_TYPE_HID_PROX, TAG_TYPE_IOPROX, TAG_TYPE_VIKING, TAG_TYPE_INDALA, TAG_TYPE_KERI, TAG_TYPE_NEXWATCH, TAG_TYPE_MOTOROLA, TAG_TYPE_IDTECK
