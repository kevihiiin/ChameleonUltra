...
#define DATA_CMD_INDALA_SCAN                    (3032)
#define DATA_CMD_INDALA_WRITE_TO_T55XX          (3033)
#define DATA_CMD_KERI_SCAN                      (3034)
#define DATA_CMD_KERI_WRITE_TO_T55XX            (3035)
#define DATA_CMD_NEXWATCH_SCAN                  (3036)
#define DATA_CMD_NEXWATCH_WRITE_TO_T55XX        (3037)
#define DATA_CMD_MOTOROLA_SCAN                  (3044)
#define DATA_CMD_MOTOROLA_WRITE_TO_T55XX        (3045)
#define DATA_CMD_IDTECK_SCAN                    (3046)
#define DATA_CMD_IDTECK_WRITE_TO_T55XX          (3047)
#define DATA_CMD_INDALA_SET_EMU_ID              (5026)
#define DATA_CMD_INDALA_GET_EMU_ID              (5027)
#define DATA_CMD_KERI_SET_EMU_ID                (5028)
#define DATA_CMD_KERI_GET_EMU_ID                (5029)
#define DATA_CMD_NEXWATCH_SET_EMU_ID            (5030)
#define DATA_CMD_NEXWATCH_GET_EMU_ID            (5031)
#define DATA_CMD_MOTOROLA_SET_EMU_ID            (5038)
#define DATA_CMD_MOTOROLA_GET_EMU_ID            (5039)
#define DATA_CMD_IDTECK_SET_EMU_ID              (5040)
#define DATA_CMD_IDTECK_GET_EMU_ID              (5041)
